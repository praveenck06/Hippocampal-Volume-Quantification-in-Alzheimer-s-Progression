...
class SlicesDataset(Dataset):
    ...
    def __init__(self, data):
        ...
        # enumerate adds index, here we are converting 3D image to 2d slices
        #format of slice    [(3d volume index,2d slice index)]
    ...
    def __getitem__(self, idx):
        ...
        data_dictionary= self.data[slc[0]]
        image= data_dictionary["image"][slc[1]]
        seg= data_dictionary['seg'][slc[1]]
