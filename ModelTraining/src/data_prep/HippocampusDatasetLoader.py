...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    #go through all the files in the image_dir and check if it is a file and not hidden
    #file
...
#         print("max:", np.max(image),"Min:",np.min(image))
        ...
        # ANSWER: This will be helpful for calculating perfomance metrics as cross entropy loss expects integers
